...
namespace graph {
    ...
    class UndirectedEdgeList : public GraphBase<UndirectedEdgeList<VertexType, WeightType>, VertexType, WeightType> {
    public:
        ...
        UndirectedEdgeList(GraphOptions options = GraphOptions(), ErrorPolicy errorPolicy = ErrorPolicy::SILENT_IGNORE)
        ...
        UndirectedEdgeList &addEdge(const VertexType &v1, const VertexType &v2, const WeightType &weight) override {
        ...
        UndirectedEdgeList &removeEdge(const VertexType &v1, const VertexType &v2) override {
            auto it = std::find_if(edges_.begin(), edges_.end(),
                                   [&v1, &v2](const Edge &e) {
                                       return (e.v1 == v1 && e.v2 == v2) || (e.v1 == v2 && e.v2 == v1);
                                   });
