...
class UndirectedAdjacencyList
    : public GraphBase<UndirectedAdjacencyList<VertexType, WeightType>,
 ...
 public:
  ...
  explicit UndirectedAdjacencyList(
      ...
      : GraphBase<UndirectedAdjacencyList, VertexType, WeightType>(options),
  ...
  UndirectedAdjacencyList &addEdge(const VertexType &v1, const VertexType &v2,
    ...
    if (this->options_.checkDuplicateEdges &&
        node1It->second.find(v2) != node1It->second.end()) {
  ...
  UndirectedAdjacencyList &removeEdge(const VertexType &v1,
