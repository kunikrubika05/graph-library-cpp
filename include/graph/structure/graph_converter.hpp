...
class GraphConverter {
 public:
  ...
  static UndirectedAdjacencyList<VertexType, WeightType>
  toUndirectedAdjacencyList(
      const UndirectedEdgeList<VertexType, WeightType> &source,
      GraphOptions options = GraphOptions()) {
  ...
  static DirectedAdjacencyMatrix<VertexType, WeightType>
  toDirectedAdjacencyMatrix(
      const DirectedEdgeList<VertexType, WeightType> &source,
      std::size_t maxVertices, GraphOptions options = GraphOptions()) {
    DirectedAdjacencyMatrix<VertexType, WeightType> target(maxVertices,
                                                           options);
    copyVertices(source, target);
    copyDirectedEdges(source, target);
    return target;
  ...
  static UndirectedAdjacencyMatrix<VertexType, WeightType>
  toUndirectedAdjacencyMatrix(
      const UndirectedEdgeList<VertexType, WeightType> &source,
      std::size_t maxVertices, GraphOptions options = GraphOptions()) {
    UndirectedAdjacencyMatrix<VertexType, WeightType> target(maxVertices,
                                                             options);
    copyVertices(source, target);
    copyUndirectedEdges(source, target);
    return target;
