...
class DirectedEdgeList
    : public GraphBase<DirectedEdgeList<VertexType, WeightType>, VertexType,
                       WeightType> {
 public:
  ...
  DirectedEdgeList(GraphOptions options = GraphOptions(),
  ...
  DirectedEdgeList &addEdge(const VertexType &from, const VertexType &to,
  ...
  DirectedEdgeList &removeEdge(const VertexType &from,
