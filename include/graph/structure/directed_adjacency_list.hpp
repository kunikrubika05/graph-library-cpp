...
class DirectedAdjacencyList
    : public GraphBase<DirectedAdjacencyList<VertexType, WeightType>,
 ...
 public:
  ...
  explicit DirectedAdjacencyList(
      ...
      : GraphBase<DirectedAdjacencyList, VertexType, WeightType>(options),
  ...
  DirectedAdjacencyList &addEdge(const VertexType &from, const VertexType &to,
    ...
    if (this->options_.checkDuplicateEdges &&
        fromIt->second.find(to) != fromIt->second.end()) {
  ...
  DirectedAdjacencyList &removeEdge(const VertexType &from,
