...
TEST(BFSTest, DisconnectedGraph) {
    UndirectedAdjacencyList<int, int> graph;
    graph.addVertex(1).addVertex(2).addVertex(3).addVertex(4).addVertex(5).addEdge(1, 2, 1).addEdge(2, 3, 1).addEdge(4, 5, 1);
...
TEST(BFSTest, OrderTest) {
    UndirectedAdjacencyList<int, int> graph;
    graph.addVertex(1).addVertex(2).addVertex(3).addVertex(4).addVertex(5).addEdge(1, 2, 1).addEdge(1, 3, 1).addEdge(2, 4, 1).addEdge(2, 5, 1).addEdge(3, 5, 1);
...
TEST(BFSTest, DistanceTest) {
    ...
    graph.addVertex(1).addVertex(2).addVertex(3).addVertex(4).addVertex(5).addEdge(1, 2, 1).addEdge(2, 3, 1).addEdge(3, 4, 1).addEdge(4, 5, 1);
...
TEST(BFSTest, ParentTest) {
    UndirectedAdjacencyList<int, int> graph;
    graph.addVertex(1).addVertex(2).addVertex(3).addVertex(4).addVertex(5).addEdge(1, 2, 1).addEdge(1, 3, 1).addEdge(2, 4, 1).addEdge(3, 5, 1);
...
TEST(BFSMatrixTest, DistanceTest) {
    ...
    graph.addVertex(1).addVertex(2).addVertex(3).addVertex(4).addVertex(5)
            .addEdge(1, 2, 1).addEdge(2, 3, 1).addEdge(3, 4, 1).addEdge(4, 5, 1);
