...
TEST(GraphConverterTest, DirectedEdgeListToAdjacencyList) {
    ...
    auto adjList = GraphConverter<std::string, double>::toDirectedAdjacencyList(edgeList);
...
TEST(GraphConverterTest, DirectedAdjacencyListToMatrix) {
    ...
    auto adjMatrix = GraphConverter<std::string, double>::toDirectedAdjacencyMatrix(adjList, 10);
...
TEST(GraphConverterTest, UndirectedToDirected) {
    ...
    auto directed = GraphConverter<std::string, int>::toDirectedEdgeList(undirected);
...
TEST(GraphConverterTest, DirectedToUndirected) {
    ...
    auto undirected = GraphConverter<std::string, int>::toUndirectedEdgeList(directed);
...
TEST(GraphConverterTest, ComplexGraphConversion) {
    ...
    original.addVertex("Москва").addVertex("Санкт-Петербург").addVertex("Новосибирск")
            .addVertex("Екатеринбург").addVertex("Казань");
    ...
    auto undirectedMatrix = GraphConverter<std::string, double>::toUndirectedAdjacencyMatrix(original, 10);
    ...
    auto directedList = GraphConverter<std::string, double>::toDirectedEdgeList(undirectedMatrix);
...
TEST(GraphConverterTest, GraphWithCycles) {
    ...
    auto undirected = GraphConverter<std::string, int>::toUndirectedEdgeList(cyclic);
    EXPECT_EQ(undirected.vertexCount(), 4);
    EXPECT_EQ(undirected.edgeCount(), 4);

    auto directed = GraphConverter<std::string, int>::toDirectedAdjacencyMatrix(undirected, 5);
...
TEST(GraphConverterTest, CustomVertexType) {
    ...
    auto matrixGraph = GraphConverter<City, double>::toDirectedAdjacencyMatrix(cityGraph, 5);
    ...
    auto undirectedGraph = GraphConverter<City, double>::toUndirectedAdjacencyList(matrixGraph);
...
TEST(GraphConverterTest, SequentialConversions) {
    ...
    auto undirectedList = GraphConverter<int, int>::toUndirectedAdjacencyList(matrix);
    auto undirectedEdgeList = GraphConverter<int, int>::toUndirectedEdgeList(undirectedList);
    auto directedAgain = GraphConverter<int, int>::toDirectedEdgeList(undirectedEdgeList);
...
TEST(GraphConverterTest, LargeGridGraph) {
    ...
    auto matrix = GraphConverter<std::pair<int, int>, int>::toUndirectedAdjacencyMatrix(grid, 400);
    auto gridAgain = GraphConverter<std::pair<int, int>, int>::toUndirectedAdjacencyList(matrix);
...
TEST(GraphConverterTest, ParallelEdges) {
    ...
    auto edgeList = GraphConverter<std::string, int>::toDirectedEdgeList(multiGraph);
...
TEST(GraphConverterTest, EmptyGraph) {
    ...
    auto converted = GraphConverter<std::string, double>::toUndirectedAdjacencyList(empty);
...
TEST(GraphConverterTest, IsolatedVertices) {
    ...
    auto matrix = GraphConverter<std::string, int>::toDirectedAdjacencyMatrix(graph, 5);
...
TEST(GraphConverterTest, NegativeWeights) {
    ...
    auto undirected = GraphConverter<int, int>::toUndirectedAdjacencyMatrix(graph, 5);
